...
const Logo = (props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} viewBox="0 0 45.651 43.416">
            <g id="Polygon" transform="translate(-1.175)" fill="none" stroke-miterlimit="10">
                ...
                <path
                    ...
                    stroke="none" fill="#ef6d58"/>
            </g>
            <path id="Polygon-2" data-name="Polygon" d="M9.5,0l9.035,6.564L15.084,17.186H3.916L.465,6.564Z"
                  transform="translate(12.825 14)" fill="#ef6d58"/>
        </svg>
    );
};
